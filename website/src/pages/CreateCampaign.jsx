...
const CreateCampaign = () => {
  ...
  return (
    <div className="bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4 mt-[90px] ">
      {isLoading && <Loader />}
      <div className="border-gray-300 flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]">
